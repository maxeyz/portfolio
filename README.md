...
- Game Programmer, Luleå University of Technology (2021-2024)
  * About: Learned programming languages such as: C++, Python, C#, and Angelscript. Created games, software, graphics and physics engines using tools such as: Unity, Unreal Engine, OpenGL. Experience working with real customers/project managers to develop their product. Theoretical and practical experience working with agile methodology, specifically Scrum.
